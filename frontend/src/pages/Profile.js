...
import { User, Mail, Phone, Calendar, ShoppingCart, Heart, LogOut, ArrowLeft, Settings } from 'lucide-react';
...
export const Profile = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8" data-testid="profile-page">
      ...
      <h1 className="text-3xl font-bold uppercase tracking-tight mb-8">Мій профіль</h1>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white border border-[#EBECEE] p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="label-industrial">Дата реєстрації</p>
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          >
            ...
            <div>
              <h3 className="font-bold">Мої замовлення</h3>
              <p className="text-sm text-[#474A51]">Історія покупок</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <h3 className="font-bold">Обране</h3>
              <p className="text-sm text-[#474A51]">Збережені товари</p>
            </div>
          </Link>
          ...
          {user?.is_admin && (
            ...
            >
              ...
              <div>
                <h3 className="font-bold">Адмін панель</h3>
                <p className="text-sm text-gray-300">Керування магазином</p>
              </div>
            </Link>
          )}
        </div>
